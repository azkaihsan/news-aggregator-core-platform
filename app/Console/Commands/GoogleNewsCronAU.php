...
class GoogleNewsCronAU extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'etl:googlenewsau';
     ...
     * @var string
     */
    protected $description = 'Routine ETL News Data from Google News AU';
    ...
    {
        $url = "https://news.google.com/rss?gl=AU&hl=en-AU&ceid=AU:en";
